...
この領域は、これまでの研究の経緯・結果・原稿を**参照しない**前提で書かれている。前提として認めるのは次の2点だけ。
...
$GOP/.venv/bin/python redo/pipeline/inventory.py
OPENBLAS_NUM_THREADS=1 $GOP/.venv/bin/python redo/pipeline/stage1_dev.py
```
