...
one. This transcript-derived PER compares canonical phone sequences of the
recognized and prompted words, so it is a phone-weighted word distance,
not a phone-level transcription of the learner's realization. Phone recognizers are compared directly with eSpeak reference phones,
...
transcripts of these corpora existed before this study. It was assembled in earlier work that inspected \so{} correlations. The
admission rule below does not use performance, no candidate was added or
removed for this study, and the excluded configurations are released with
their reasons. Admission is decided before any result is seen:
...
signal here, which bounds the inference cost of a practical panel; whether
such smaller panels transfer equally was not tested.
...
This study reanalyses existing corpora obtained through their providers'
procedures; no participants were recruited and no new recordings or ratings
were collected.
