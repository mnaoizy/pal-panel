...
matters more than curation: eight arbitrary listeners land within a few hundredths of the full panel, equal weights are not improved by medians
or error-based weights, and the one composition effect that reached
significance on the development split, family breadth, did not reach it
on the external criterion. Random eight-listener subsets already captured most of the full-panel
